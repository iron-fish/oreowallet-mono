...
impl RpcHandler {
    ...
    pub fn get_asset_info(
        &self,
        request: RpcGetAssetInfoRequest,
    ) -> Result<RpcResponse<RpcAsset>, OreoError> {
